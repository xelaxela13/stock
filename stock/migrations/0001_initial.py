# Generated by Django 2.1 on 2019-02-15 20:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(0, 'Приходная накладная'), (1, 'Расходная накладная')], default=0, verbose_name='Тип накладной')),
